...
const config: Config = {
  ...
  transformIgnorePatterns: ['node_modules/(?!@angular|ngx-cookie-service)'],
  moduleNameMapper: {
    '^@services/(.*)$': [
    ...
    '^@facades/(.*)$': [
      '<rootDir>/src/app/core/facades/$1',
      '<rootDir>/src/app/portal/facades/$1',
      '<rootDir>/src/app/admin/facades/$1',
    ],
    ...
    '^@constants/(.*)$': [
      '<rootDir>/src/app/portal/constants/$1',
      '<rootDir>/src/app/admin/constants/$1',
      '<rootDir>/src/app/core/constants/$1',
    ],
