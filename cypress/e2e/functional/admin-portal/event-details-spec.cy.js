...
describe('Admin - Event details', () => {
  ...
  describe('Verify "Basic Details" tab', () => {
    it('should display the correct basic details', () => {
      ...
      cy.get('#associated-cases').within(() => {
        ...
        cy.get('table.govuk-table tbody tr')
          ...
          .within(() => {
            ...
            cy.get('.courthouse').should('contain.text', 'Courthouse 1');
          });
        ...
        cy.get('table.govuk-table tbody tr')
          ...
          .within(() => {
            cy.get('.case-id a')
              .should('have.attr', 'href', '/admin/case/2?backUrl=%2Fadmin%2Fevents%2F111')
              .and('contain.text', 'CASE12');
            cy.get('.courthouse').should('contain.text', 'Courthouse 2');
          });
      });
    });
        ...
        cy.get('table.govuk-table tbody tr')
          ...
          .within(() => {
            ...
            cy.get('.hearing-date a')
              .should('have.attr', 'href', '/admin/case/1/hearing/1?backUrl=%2Fadmin%2Fevents%2F111')
  ...
  describe('Verify "Advanced Details" tab', () => {
    it('should display the correct advanced details', () => {
